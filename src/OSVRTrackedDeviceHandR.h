...
#ifndef INCLUDED_OSVRTrackedDeviceHandR_h_GUID_128E3B29_F5FC_4221_9B38_14E3F402E643
#define INCLUDED_OSVRTrackedDeviceHandR_h_GUID_128E3B29_F5FC_4221_9B38_14E3F402E643
...
class OSVRTrackedDeviceHandR : public vr::ITrackedDeviceServerDriver, public vr::IVRControllerComponent {
friend class ServerDriver_OSVR;
public:
    OSVRTrackedDeviceHandR(const std::string& display_description, osvr::clientkit::ClientContext& context, vr::IServerDriverHost* driver_host, vr::IDriverLog* driver_log = nullptr);

    virtual ~OSVRTrackedDeviceHandR();
    // ------------------------------------
    // Management Methods
    // ------------------------------------
    /**
...
private:
     ...
     * from the tracker.
     */
	static void HandRTrackerCallback(void* userdata, const OSVR_TimeValue* timestamp, const OSVR_PoseReport* report);
...
#endif // INCLUDED_OSVRTrackedDeviceHandR_h_GUID_128E3B29_F5FC_4221_9B38_14E3F402E643
